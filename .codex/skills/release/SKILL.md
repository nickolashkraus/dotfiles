...
name: release
description: >
  Cut a release for a Function Health service. Gathers PRs, creates
...
`~/.codex/rules/typography.md` and `~/.codex/rules/git.md`. In
...
Parse the user-provided skill input for:
