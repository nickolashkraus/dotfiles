...
Read the other agents' findings from these files:
{other_findings_paths}

## Instructions

1. Read your own findings file first, then all other agents'
   findings files.
...
- **Confirmations**: Findings from other agents that you can
  independently verify.
- **Verdict**: "Complete" (nothing to add) or "Has additions"
  (new findings added).
